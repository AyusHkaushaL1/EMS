   ...
   const [userData, setUserData]= useContext(AuthContext)
    return (
        <div className='  p-5 rounded mt-5 '>
           ...
           <div className='bg-blue-400 py-2 flex rounded justify-between px-4 mb-2'>
           ...
           {userData.map(function(elem , idx){
               return  <div  key={idx} className='border-2 border-blue-500 py-2 flex rounded justify-between px-4 mb-2'>
